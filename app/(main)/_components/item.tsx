...
export const Item = ({
    ...
    return(
        ...
        >
            {/* boolean checking if the id is id{documents} or undefined */}
            {/* {!!id && (
                <div 
                    role="button"
                    className="h-full rounded-s hover:bg-neutral-300 dark:hover:bg-neutral-600 mr-1"
            ...
            {isSearch && (
                <kbd className="ml-auto pointer-events-none inline-flex
                    ...
                    opacity-100"
                >
                    {/* <span className="text-xs">ꕤ</span>K */}
                </kbd>
            )}
            {!!id && (
...
Item.Skeleton = function ItemSkelenton({level}: {level?:number}){
    return(
        <div style={{
